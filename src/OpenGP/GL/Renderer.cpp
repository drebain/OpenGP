...
namespace {
    ...
    const static char *global_uniforms = R"GLSL(
    ...
    const static char *vshader_preamble = R"GLSL(

    )GLSL";

    const static char *base_vshader = R"GLSL(
    ...
    const static char *base_fshader = R"GLSL(
